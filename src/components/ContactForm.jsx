            ...
            <div>
                <form className="space-y-4 text-black mt-5 pr-6 pl-6">
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <textarea id="message" rows="6" className="block p-2.5 w-full text-sm text-black rounded-lg shadow-sm border border-gray-400" placeholder="Leave a comment..."></textarea>
                    </div>
                    <Button title='submit' bg='bg-blue-600' />
                </form>
            </div>
        </>
    )
